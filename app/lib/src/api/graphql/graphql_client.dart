...
import 'package:app/src/api/graphql/links/add_auth_header_link.dart';
...
IsolateClient graphqlClient(GraphqlClientRef ref) {
...
Future<IsolateClient> createClient({required StreamingSharedPreferences tokenStore, required String endpoint}) async {
...
Future<Client> _initClientInIsolate(_InitParams params, SendPort? sendPort) async {
