...
class GeolocatorRepository {
  GeolocatorRepository(this.ref);
  final Ref ref;
  get geolocator => ref.read(geolocatorWrapperProvider);
...
@riverpod
Future<Position> determineUserPosition(DetermineUserPositionRef ref) async {
  return ref.read(geolocatorRepositoryProvider).determinePosition();
}
